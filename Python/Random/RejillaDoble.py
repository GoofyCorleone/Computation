...
D = 0.25 * mm  #slits separation
F.add(RectangularSlit(width = 0.1*mm, height = 3*cm, x0 = -D/2 , y0 = 0)   +   RectangularSlit(width = 0.1*mm, height = 3*cm, x0 = D/2, y0 = 0))
...
F.zoom_propagate(11*cm, x_interval = [-3 * mm, 3 * mm], y_interval = [-1*mm, 1*mm])
