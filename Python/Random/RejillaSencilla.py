...
# F.add(RectangularSlit(width = 0.668*mm, height = 0.668*mm, x0 = 0 , y0 = 0))
F.add(RectangularSlit(width = 0.08*mm, height = 8*cm, x0 = 0 , y0 = 0))
...
F.zoom_propagate(3.5*cm, x_interval = [-1.4 * mm, 1.4 * mm], y_interval = [-1.4*mm, 1.4*mm])  # Dim sensor
